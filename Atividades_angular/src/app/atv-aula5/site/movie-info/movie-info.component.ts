...
export class MovieInfoComponent implements OnInit{
  ...
  moviedb = [
    ...
    {id: 13, category: "Comédia", name: 'Gente Grande', cover: 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/ppU2xJnlKdW3F01AtC9wMuXRZCg.jpg', nota: 63, diretor: 'Dennis Dugan', original: 'Grown Ups', ano: 2010, status: 'Lançado', phrase: 'Boys will be boys. . . some longer than others.', duration: '1h 42m'},
    {id: 14, category: "Comédia", name: 'Te peguei!', cover: 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/gI6zwlVk1Bu3FnkcDkCYYHsBhTz.jpg', nota: 67, diretor: 'Jeff Tomsic', original: 'Tag', ano: 2018, status: 'Lançado', phrase: 'Based on a true story. We’re not kidding', duration: '1h 40m'},
    {id: 15, category: "Comédia", name: 'Free Guy: Assumindo o Controle', cover: 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/jXlGeLOg2RKHmV9CinVaIB4ijKU.jpg', nota: 76, diretor: 'Matt Lieberman', original: 'Free Guy', ano: 2021, status: 'Lançado', phrase: 'A vida é muito curta para ser um personagem secundário.', duration: '1h 54m'},
  ];
